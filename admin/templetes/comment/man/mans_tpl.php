	...
	<div class="container-fluid">
		<div class="row">
			<ol class="breadcrumb float-sm-left">
				...
				<li class="breadcrumb-item active">Quản lý bình luận - <strong class="text-uppercase"></strong></li>
			</ol>
		</div>
	</div>
</section>
...
<section class="content">
	<div class="card-footer text-sm sticky-top">
		<a class="btn btn-sm bg-gradient-danger mr-1" href="" title="Thoát"><i class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
		<a class="btn btn-sm bg-gradient-primary mr-1" href="" target="_blank" title=""><i class="far fa-eye mr-1"></i>Xem chi tiết</a>
	</div>
				...
				<div class="card-body">
					<div class="comment-avg-point mb-4">
						<div class="text-center">
							<div class="comment-point"><strong>>/5</strong></div>
							...
							<div class="comment-count"><a>( nhận xét)</a></div>
						</div>
					</div>
					<div class="comment-progress-percent">
						<div class="comment-progress rate-5">
							...
							<div class="progress">
								<div class="progress-bar" id="has-rate" style="width: %">
