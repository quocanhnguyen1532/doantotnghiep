...
<BODY>
    <div id="alert">
        <i class="fas 'fa-check-circle fasuccess':'fa-exclamation-triangle fadanger'"></i>
        <div class="title">Thông báo</div>
        <div class="message alert'alert-success' : 'alert-danger'?>"></div>
        <div class="rlink">(<a href="" >Click vào đây nếu không muốn đợi lâu</a>)</div>
        <div class="progress"><div id="process-bar" class="progress-bar progress-bar-striped progress-bar-'success' : 'danger'?> active" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div></div>
    </div>
